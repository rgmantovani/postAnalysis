...
# Description: Data Analysis in a huge data frame, with more than 
# 400 tasks and 50 learners

#--------------------------------------------------------------------------------------------------
#--------------------------------------------------------------------------------------------------

analysisHugeData = function() {

  devtools::load_all()
  subdir = "plots/huge_data/"
  if(!dir.exists(subdir)) {
    cat(" - Creating dir:", subdir, "\n")
    dir.create(subdir)
  }
  
  load(file = "data/full_data_results.RData")
